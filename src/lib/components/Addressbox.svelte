<script lang="ts">
    import Address from "$lib/images/address.jpg";
    import EmailSvg from "$lib/components/svgs/emailSvg.svelte";
    import PhoneSvg from "./svgs/phoneSvg.svelte";
    import MapSvg from "./svgs/mapSvg.svelte";
</script>
...
<style lang="scss">
    .contact-box {
        ...
        // border-top: 8px solid var(--attention);
