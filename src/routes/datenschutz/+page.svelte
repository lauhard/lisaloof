...
<svelte:head>
    ...
    <meta 
        name="description" 
        content="Datenschutzerklärung Lisaloof.com" 
    />
</svelte:head>
...
<div class="section">
    ...
    <div class="grid">
        <div class="cell datenschutz">
            ...
            <p>
                <strong>Verantwortlich für die Datenverarbeitung ist:</strong>
            </p>
            <ul class="no-list">
                <li>
                    Lisa-Marie Loof
            ...
            <ul>
                <li>
                    <strong>Temporäre Cookies (Session Cookies):</strong>
...
Berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO
            ...
            <ul class="no-list">
                <li>
                    Dienstanbieter: Vercel
                </li>
                <li>
                    Internetseite: an Francisco, Kalifornien, U.S
                </li>
                <li>
                    Datenschutzerklärung: https://vercel.com/
                </li>
            </ul>
            <h3>
            ...
            <p>
                Technische Optimierung der Internetpräsenz, Analyse von Fehlern und Nutzerverhalten
            </p>
            <h5>
                Rechtsgrundlage:
            </h5>
...
Zu welchem Zweck und in welchem Umfang Daten von dem Anbieter erhoben werden, können Sie den jeweiligen, im Folgenden mitgeteilten, Datenschutzerklärungen der Anbieter entnehmen.
            ...
            <ul class="no-list">
                ...
                <li>
                    <a href="http://instagram.com/about/legal/privacy">Datenschutzerklärung</a>
                </li>
            </ul>
            <h3>
